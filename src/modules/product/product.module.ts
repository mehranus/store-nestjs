...
@Module({
  imports:[TypeOrmModule.forFeature([ProductEnitiy,ProductColorEnitiy,ProductDitelsEnitiy,ProductSizeEnitiy])],
  controllers: [ProductController,ProductSizeController,ProductColorController,ProductDetilsController],
